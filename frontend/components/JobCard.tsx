            ...
            <div className="flex gap-3">
                ...
                {job.result_url && (
                    <a
                        href={job.result_url}
                        target="_blank"
                        className="flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-xl text-sm font-bold hover:scale-105 hover:bg-green-500 transition-all shadow-lg shadow-green-900/20"
